...
import 'package:tracklaw/First_page/openingPage.dart';
...
import 'package:tracklaw/homescreen/legistlationPage.dart';

class Homescreen extends StatefulWidget {
  final List<Bill> bills;
  final Map<String, List<BillActions>> actions;

  Homescreen({Key? key, required this.bills, required this.actions})
      : super(key: key);
  @override
          ...
          Expanded(
            child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  final actions = widget.actions[bill.billId] ??
                  ...
                  var mostRecentAction =
                      (actions.isNotEmpty && actions.length > 0)
                  ...
                  return BillCard(
                    bill: bill,
                    action:
                        mostRecentAction!, // Pass null if no summaries exist
                  );
                },
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        backgroundColor:
            Color.fromARGB(255, 236, 189, 142), // Button background color
      ...
      onPressed: () {
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  LegistlationPage(bill: widget.bill, action: widget.action)),
        );
      },
    );
  }
